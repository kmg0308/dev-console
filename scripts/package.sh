...
VERSION="${VERSION:-0.1.0}"; BUILD_NUMBER="${BUILD_NUMBER:-1}"; DIST="$ROOT_DIR/dist"; APP="$DIST/DevConsole.app"; COMPONENT_PLIST="$DIST/DevConsole-component.plist"
...
rm -rf "$DIST"; mkdir -p "$APP/Contents/MacOS" "$APP/Contents/Helpers"
